...
> **Importante:** Não use `pip install clawteam` — isso instala a versão upstream do PyPI, que usa `claude` como padrão e não possui as adaptações para OpenClaw. Sempre instale a partir deste repositório.
