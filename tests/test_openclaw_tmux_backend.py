...
def test_tmux_backend_uses_openclaw_agent_mode_instead_of_tui(monkeypatch, tmp_path):
    ...
    assert "openclaw agent --session-id clawteam-demo-team-worker1 --message 'do work'" in full_cmd
    assert "openclaw tui" not in full_cmd
