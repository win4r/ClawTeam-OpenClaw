...
> **Importante:** Non usare `pip install clawteam` — installa la versione upstream da PyPI, che usa `claude` come predefinito e non include gli adattamenti per OpenClaw. Installa sempre da questo repository.
