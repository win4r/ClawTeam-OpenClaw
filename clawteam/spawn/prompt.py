...
def build_agent_prompt(
    ...
    lines.extend([
        ...
        f"- IMPORTANT: spawned OpenClaw workers run under exec allowlist mode. Use only the allowlisted executable path from $CLAWTEAM_CMD (or $CLAWTEAM_BIN), not arbitrary shell commands.",
